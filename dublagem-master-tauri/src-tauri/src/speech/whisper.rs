...
impl WhisperRsTranscriber {
    #[cfg(all(feature = "ml", feature = "cuda"))]
    pub async fn preload(model_path: PathBuf) -> AppResult<Self> {
    ...
    pub async fn preload(_model_path: PathBuf) -> AppResult<Self> {
...
async fn transcribe_with_model(
    ...
    #[cfg(feature = "cuda")]
    {
        ...
        transcribe_with_context(context, audio_path, source_language, target_language).await
    }
}
